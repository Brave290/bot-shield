...
export default function DocsPage() {
  ...
  const sections = [
    { id: "quickstart", title: "Quickstart", body: "Add one script tag to any page. The widget auto-starts in the branded modal, adds a hidden token to forms marked data-botshield, and points its API calls at BotShield automatically.", code: `<script\n  src="${origin}/bot-shield.js"\n  data-api-key="bs_live_your_key"\n  data-mode="modal"\n></script>\n\n<form data-botshield action="/signup" method="post">\n  <!-- bot_shield_token is added after verification -->\n</form>` },
