...
export function CustomSelect({ id, value, defaultValue, onChange, children, className = "" }: Props) {
  ...
  return <div ref={root} className="relative" id={id}>
    <input tabIndex={-1} aria-hidden="true" value={current} readOnly className="pointer-events-none absolute h-px w-px opacity-0" />
